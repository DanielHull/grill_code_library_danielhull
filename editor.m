classdef editor
    ...
    %   sl.obj
    %   
    % This class was generated by Jim...My portion is the final part
    properties
    end
    ...
    methods (Static,Hidden)
       ...
       % My code
           % Generating the colon link and period link using edit and
           % mlint
           
           
           edit_cmd         = sprintf('edit(''%s'')',sl.obj.getFullMethodName(objs,cur_method)); % I have a question about this
           ...
           % Generate a static string if the method is Static Still
           % generating an error
           ...
           % needed to move this down because it needed the input of the
           % SEP_STR. 
           space_for_help_text = n_chars_max - max_method_name_length - length(SEP_STR);
           
           % This is the help_cmd that you had formerly been generating
           ...
           %putting it all together and finishing the output one loop at a
           %time
